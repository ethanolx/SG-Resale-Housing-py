...
def get_regression_plot(pipeline, input_bounds, bedrooms, floor_area_sqm, approval_date, lease_commencement_year):
    ...
    def get_regression_plot(variable, mark, ax, pipeline, input_bounds, **kwargs):
    ...
    def get_regression_plots(input_bounds, pipeline, bedrooms, floor_area_sqm, approval_date, lease_commencement_year):
        ...
        get_regression_plot(input_bounds=input_bounds, variable='bedrooms', mark=bedrooms, bedrooms=bedrooms, floor_area_sqm=floor_area_sqm,
                            approval_date=approval_date, lease_commencement_year=lease_commencement_year, ax=ax[0, 0], pipeline=pipeline)
        get_regression_plot(input_bounds=input_bounds, variable='floor_area_sqm', mark=floor_area_sqm, bedrooms=bedrooms, floor_area_sqm=floor_area_sqm,
                            approval_date=approval_date, lease_commencement_year=lease_commencement_year, ax=ax[0, 1], pipeline=pipeline)
        get_regression_plot(input_bounds=input_bounds, variable='approval_date', mark=approval_date, bedrooms=bedrooms, floor_area_sqm=floor_area_sqm,
                            approval_date=approval_date, lease_commencement_year=lease_commencement_year, ax=ax[1, 0], pipeline=pipeline)
        get_regression_plot(input_bounds=input_bounds, variable='lease_commencement_year', mark=lease_commencement_year, bedrooms=bedrooms, floor_area_sqm=floor_area_sqm,
                            approval_date=approval_date, lease_commencement_year=lease_commencement_year, ax=ax[1, 1], pipeline=pipeline)
        plt.tight_layout()
        return fig

    return get_regression_plots(input_bounds=input_bounds, pipeline=pipeline, bedrooms=bedrooms, floor_area_sqm=floor_area_sqm, approval_date=approval_date, lease_commencement_year=lease_commencement_year)
